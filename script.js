const app = document.querySelector('.app'),
 ...
 OPENAI_API_KEY = "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"
    ...
    <div class="result">
            <div class="question">
                <iconify-icon icon="bi:person-gear" class="icon blue"></iconify-icon>
                 <h3>${question}</h3> 
                 <button class="copy-button" onclick="copyConversation(this)">Copy Conversation</button>
            </div>
            <div class="answer">
...
function copyConversation(button) {
    ...
    const conversation = resultDiv.querySelector('.question h3').textContent + '\n' +
                        resultDiv.querySelector('.answer p').textContent;

    const tempTextarea = document.createElement('textarea');
    tempTextarea.value = conversation;
